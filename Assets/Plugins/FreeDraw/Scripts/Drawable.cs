...
namespace FreeDraw
{
    ...
    {
        public static Color32 PEN_COLOR = new Color32(255, 0, 0, 255); // Pen color
        public static int PEN_WIDTH = 3;  // Pen radius in pixels
        ...
        public Color32 ResetColor = new Color32(0, 0, 0, 0);  // By default, reset the canvas to be transparent
...
// BRUSH TYPES. Implement your own here
        ...
        void Awake()
        {
            ...
            clean_colours_array = new Color32[(int)drawable_sprite.rect.width * (int)drawable_sprite.rect.height];
        ...
        public void ColourPixels(Vector2 center_pixel, int pen_thickness, Color32 color_of_pen)
        {
            // Figure out how many pixels we need to colour in each direction (x and y)
            int center_x = (int)center_pixel.x;
            int center_y = (int)center_pixel.y;
        ...
        {
            drawable_texture.SetPixels32(clean_colours_array);
            drawable_texture.Apply();
        }
    }
}